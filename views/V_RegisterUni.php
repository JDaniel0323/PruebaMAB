...
<body>
    ...
    <div class=" row h-100  mb-3 shadow">
        ...
        <div class="col-md-6 d-flex flex-column justify-content-between bg-light p-5">
            ...
            <form method="post" action="/MAB/controller/C_RegisterUni.php" style="width: 100%; max-width: 400px;">
                    
                    <div class="mb-3 text-muted">
                        <small>Ingresa un nombre de usuario para identificarte</small>
                        <input 
                            type="text" 
                            name="txtusuario" 
                            class="form-control mt-1"
                            placeholder="Ej: DanielToscano"
                            required
                        >
                    </div>

                    <div class="mb-4 text-muted">
                        <small>Crea una contraseña segura</small>
                        <input 
                            type="password" 
                            name="txtpassword" 
                            class="form-control mt-1"
                    ...
                    <div class="text-center mt-4">
                        <p class="small text-secondary">¿Ya tienes una cuenta?</p>
                        <a href="/MAB/controller/C_LoginUni.php" class="fw-bold">Iniciar Sesión</a>
                    </div>
                </form>
